...
帧格式与三菱 QnA 兼容 3E 完全一致(副头部 ``50 00``、成批读 0104/写 0114、
结束代码语义),仅软元件记号与软元件码不同(R/DM/ZR 用基恩士记号),
因此本模块只覆写软元件码表并把帧型固定为 3E,
收发、按长收包与解析全部复用 :mod:`omniplc.plc.melsec`。
...
class KeyenceMcTcpClient(MelsecMcTcpClient):
