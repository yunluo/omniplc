...
#### 2.2.6 0406 subcommand=0000 硬编码 — **P2(实锤,待手册)**
- `plc/melsec/codec_qna.py:184-211`
- iQ-R 扩展 0002 不支持,跨网单事务不可用。
- **修复**:subcommand 可选。**0002 的块布局(iQ-R 链接直接/模块访问,逐块 network/pc/device)须对照 MC 手册 SH-080008/SH-081257 实现,未获取手册前不臆造**;README/docstring 已显式声明该限制。
